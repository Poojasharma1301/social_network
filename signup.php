...
<div class="col-xs-12">
	...
	<div class="header">
	<h3 style="text-align: center;"><strong>Join Knowledge AND Research</strong></h3>
	<hr>
	</div>
	<div class="l-part">
	...
	<input id="password" type="password" class="form-control" placeholder="Enter your Password" name="u_pass" required="required">
	</div><br>
	<div class="input-group">
	<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
	<input id="email" type="email" class="form-control" placeholder="username@site.com" name="u_email" required="required">
					</div><br>
					<div class="input-group">
